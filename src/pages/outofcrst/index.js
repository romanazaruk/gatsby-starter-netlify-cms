...
export default function Index() {
  ...
  return (
    <Layout>
      <div className="outofcrst-container-main">
        <div className="outofcrst-container">
          <div className="outofcrst-title">
            ...
            <p className="outofcrst-title-p">
              Out of Curiosity promotes ideas, concepts and mental models to
              help get 1% better everyday in work and life. Subscribe to the
              newsletter and podcast for a constant stream of inspiration.
            </p>
          </div>
